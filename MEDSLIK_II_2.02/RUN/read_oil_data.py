...
if __name__ == '__main__':
   ...
   parser.add_argument('option', type=string, help='Either "name" or "api"')

   path = 'MEDSLIK_II_2.02/RUN/oilbase.csv'

   read_oilbase(value,path,option)
